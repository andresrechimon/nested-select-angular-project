// To parse this data:
//
//   import { Convert, CountrySmall } from "./file";
//
//   const countrySmall = Convert.toCountrySmall(json);
//
...
export class Convert {
    public static toCountrySmall(json: string): CountrySmall {
        return cast(JSON.parse(json), r("CountrySmall"));
    }

    public static countrySmallToJson(value: CountrySmall): string {
        return JSON.stringify(uncast(value, r("CountrySmall")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "NativeName": o([
        { json: "bel", js: "bel", typ: r("Translation") },
        { json: "rus", js: "rus", typ: r("Translation") },
    ], false),
    "Translation": o([
        { json: "official", js: "official", typ: "" },
        { json: "common", js: "common", typ: "" },
